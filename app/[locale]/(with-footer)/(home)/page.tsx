...
export default async function Page() {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='mx-auto w-full max-w-[1200px] px-4 py-12 lg:py-20'>
        <div className='space-y-24'>
          ...
          <section>
            ...
            <div className='mt-12 flex justify-center'>
              ...
              >
                {t('exploreMore')}
                <CircleChevronRight className='size-5 transition-transform group-hover:translate-x-1' />
              </Link>
            </div>
          </section>
